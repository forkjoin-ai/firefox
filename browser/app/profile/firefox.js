...
pref("forkjoin.gnosis.scheduler.enabled", false);
pref("forkjoin.gnosis.scheduler.observe.enabled", true);
pref("forkjoin.gnosis.scheduler.active.enabled", false);
pref("forkjoin.gnosis.scheduler.throttled.enabled", false);
pref("forkjoin.gnosis.storage.observe.enabled", true);
pref("forkjoin.gnosis.storage.active.enabled", false);
pref("forkjoin.gnosis.auth.observe.enabled", true);
pref("forkjoin.gnosis.auth.active.enabled", false);
pref("forkjoin.gnosis.auth.custodial_wallet.enabled", false);
pref("forkjoin.gnosis.network.enabled", false);
