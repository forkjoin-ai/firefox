...
// Forkjoin zero-commercial defaults. These final overrides keep first-run
// Firefox focused on browsing and sovereign Forkjoin surfaces, not Mozilla
// sponsored content, remote recommendations, news, weather, or telemetry.
pref("app.normandy.api_url", "");
pref("app.normandy.enabled", false);
pref("app.shield.optoutstudies.enabled", false);
pref("browser.backup.template.fallback-download.release", "");
pref("browser.backup.template.fallback-download.beta", "");
pref("browser.backup.template.fallback-download.aurora", "");
pref("browser.backup.template.fallback-download.nightly", "");
pref("browser.backup.template.fallback-download.esr", "");
...
pref("browser.newtabpage.activity-stream.default.sites", "https://wiki.forkjoin.ai,https://storms.watch,https://skychat.forkjoin.ai,https://skymesh.forkjoin.ai/watch,https://edgework.forkjoin.ai,https://dashrelay.forkjoin.ai,https://forkjoin.ai");
...
pref("nimbus.telemetry.targetingContextEnabled", false);
pref("permissions.desktop-notification.telemetry.siteCategories", "{}");
...
pref("services.sync.prefs.sync.browser.urlbar.suggest.quicksuggest.nonsponsored", false);
pref("services.sync.prefs.sync.browser.urlbar.suggest.quicksuggest.sponsored", false);
pref("services.sync.prefs.sync.browser.urlbar.suggest.weather", false);
pref("toolkit.contentRelevancy.enabled", false);
pref("toolkit.contentRelevancy.ingestEnabled", false);
...
pref("aeon.protocol.wall.experimental.enabled", false);
pref("aeon.protocol.wall.path", "/Users/buley/Documents/Code/monorepo/open-source/aeon/packages/wall/wall");
pref("aeon.protocol.wall.timeout_ms", 10000);
pref("forkjoin.gnosis.runtime.enabled", true);
pref("forkjoin.gnosis.scheduler.enabled", true);
pref("forkjoin.gnosis.scheduler.observe.enabled", true);
pref("forkjoin.gnosis.scheduler.active.enabled", true);
pref("forkjoin.gnosis.scheduler.throttled.enabled", true);
pref("forkjoin.gnosis.storage.observe.enabled", true);
pref("forkjoin.gnosis.storage.active.enabled", true);
pref("forkjoin.gnosis.auth.observe.enabled", true);
pref("forkjoin.gnosis.auth.active.enabled", true);
pref("forkjoin.gnosis.auth.custodial_wallet.enabled", true);
pref("forkjoin.gnosis.entropy.observe.enabled", true);
pref("forkjoin.gnosis.entropy.active.enabled", true);
